...
PHONE_IN_API = "http://cybersameer-jarvis-apis1.onrender.com/num?key=VIRAT&num={num}"
PHONE_PK_API = "http://cybersameer-jarvis-apis1.onrender.com/pakistan?key=VIRAT&num={num}"
AADHAAR_API = "http://cybersameer-jarvis-apis1.onrender.com/aadhar?key=VIRAT&id={aadhaar}"
FAMILY_AADHAAR_API = "https://yourapi.com/family?id={aadhaar}"
INSTAGRAM_API= "http://cybersameer-jarvis-apis1.onrender.com/instagram?key=VIRAT&username={inst}"
TGINFO_API= "http://cybersameer-jarvis-apis1.onrender.com/tginfo?key=VIRAT&iduser={tg}"
VEHICLE_API = "http://cybersameer-jarvis-apis1.onrender.com/vehicle?key=VIRAT&rc={rc}"
...
def main_menu_keyboard():
    ...
    kb = [
        ...
        [InlineKeyboardButton("INST 📷", callback_data="inst"),
         InlineKeyboardButton("IFSC 🏦", callback_data="ifsc"),
         InlineKeyboardButton("Vehicle/TG 🚗", callback_data="vehicle_rc")],
...
async def generic_callback(update: Update, context: CallbackContext):
    ...
    if data in ("phone_in", "phone_pk", "aadhaar", "inst", "ifsc", "vehicle_rc", "upi"):
